...
public class StatsServlet extends HttpServlet {
    ...
    private static final String DYNAMODB_TABLE_NAME = "SWIPE_LIKE_QUERY";
...
//                service.getDynamoDBItemStats(ddb, DYNAMODB_TABLE_NAME, swipeLikes);
                service.getDynamoDBItem(ddb, DYNAMODB_TABLE_NAME, swipeLikes);
                MatchStats matchStats = new MatchStats(swipeLikes.getLikes(), swipeLikes.getDislikes());
