...
public class SwipeMatchConsumer implements Runnable {
    ...
    private static final String DYNAMODB_TABLE_NAME_NEW = "SWIPE_MATCH_NEW";
    ...
    public void run() {
        ...
        try {
            ...
            DeliverCallback deliverCallback = (consumerTag, delivery) -> {
                ...
                try {
                    service.getDynamoDBItem(ddb, DYNAMODB_TABLE_NAME_NEW, swipeMatches);
                    ...
                    service.putItemInTable(ddb, DYNAMODB_TABLE_NAME_NEW, swipeMatches);
                    System.out.println(String.format("%s table update successfully. The matches for userId: %s is %s", DYNAMODB_TABLE_NAME_NEW, swiper, set));
